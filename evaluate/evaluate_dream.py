...
@torch.no_grad()
def generate_dream(model, tokenizer, input_ids, attention_mask=None, max_new_tokens=32, 
                   temperature=0.2, top_p=0.95, steps=32):
    """Generate response using Dream model"""
...
def process_single_item(model, tokenizer, device, json_data: Dict[str, Any], 
                       max_new_tokens=32, temperature=0.2, top_p=0.95,
                       steps=32, max_passages=5):
